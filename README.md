# Web Crawler Index Seacrh

A localhost-runnable web crawler and search application built with **Flask**, **MySQL**, and Python standart-library crawling primitives. The app lets you:

- start a crawl from an origi URL with a max depth,
